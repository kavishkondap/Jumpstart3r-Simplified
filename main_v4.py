...
title_section ()
numbers_section ()
st.markdown ("<h2 style='text-align: center;'>Note that this is a simplified version of the Jumpstart3r app for low-resouce devices. Functionality will be the same, but this website has omitted non-essential sections of the app. To see the complete Jumpstart3r website, <a href='https://jumpstart3r.streamlit.app/'>click here</a> or visit jumpstart3r.streamlit.app</h2>", unsafe_allow_html=True)
ml_section()
# about_section()
# mission_section()
data_section()
